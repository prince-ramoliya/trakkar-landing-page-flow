...
const NavLink: React.FC<NavLinkProps> = ({ href = "#", children, hasDropdown = false, className = "", onClick }) => (
   ...
   >
     ...
     {!hasDropdown && (
         <motion.div
           className="absolute bottom-[-2px] left-0 right-0 h-[1px] bg-blue-500"
        ...
        >
            <nav className="flex justify-between items-center max-w-screen-xl mx-auto h-[70px]">
                ...
                <div className="flex items-center flex-shrink-0 space-x-4 lg:space-x-6">
                    ...
                    <motion.a
                        href="#"
                        className="bg-blue-500 text-white px-4 py-[6px] rounded-md text-sm font-semibold hover:bg-blue-600 transition-colors duration-200 whitespace-nowrap shadow-sm hover:shadow-md"
        ...
        <main className="flex-grow flex flex-col items-center justify-center text-center px-4 pt-8 pb-16 relative z-10">
            ...
            >
                ...
                <span className="inline-block h-[1.2em] sm:h-[1.2em] lg:h-[1.2em] overflow-hidden align-bottom">
                    <RotatingText
                        texts={['Boost', 'Track', 'Monitor', 'Increase', 'Maximize']}
                        mainClassName="text-blue-500 mx-1"
                        staggerFrom={"last"}
                        initial={{ y: "-100%", opacity: 0 }}
                        animate={{ y: 0, opacity: 1 }}
            ...
            >
                <input
                    ...
                    className="flex-grow w-full sm:w-auto px-4 py-2 rounded-md bg-[#2a2a2a] border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                />
                <motion.button
                    type="submit"
                    className="w-full sm:w-auto bg-blue-500 text-white px-5 py-2 rounded-md text-sm font-semibold hover:bg-blue-600 transition-colors duration-200 whitespace-nowrap shadow-sm hover:shadow-md flex-shrink-0"
                    whileHover={{ scale: 1.03, y: -1 }}
                    whileTap={{ scale: 0.97 }}
                    transition={{ type: "spring", stiffness: 400, damping: 15 }}
                >
            ...
            >
                <img
                    ...
                    alt="Trakkar dashboard showing time tracking, screenshots, and productivity analytics"
                    width={1024}
                    height={640}
